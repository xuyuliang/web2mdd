...
class TestExtractDefinition:
    ...
    def test_extract_definition_basic(self):
        """从 coca2 标签提取第一个中文释义"""
        from app.tiny_dict_parser import extract_definition
...
class TestExtractVerbForms:
    ...
    def test_extract_verb_forms_basic(self):
        """提取动词变形"""
        from app.tiny_dict_parser import extract_verb_forms
...
class TestExtractNounForms:
    ...
    def test_extract_noun_forms_basic(self):
        """提取名词变形"""
        from app.tiny_dict_parser import extract_noun_forms
...
class TestExtractAll:
    ...
    def test_extract_all_with_all_fields(self):
        """测试包含所有字段的 HTML"""
        from app.tiny_dict_parser import extract_definition, extract_verb_forms, extract_noun_forms
